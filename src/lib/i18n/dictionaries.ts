...
export const fr = {
  ...
  catalog: {
    ...
    unitOfMeasure: "Unité",
    unitCost: "Coût de référence",
    sellingPrice: "Prix de vente TTC",
    wholesalePrice: "Prix de gros TTC",
    priceInclVatHint:
      "Les prix de vente se saisissent TTC, le montant payé par le client. La base HT est calculée automatiquement.",
    priceExclVat: "Dont HT",
    unitCostExclVatHint: "Coût d'achat HT, hors TVA.",
    vatRate: "Taux de TVA",
    vatExempt: "Exonéré de TVA",
    reorderLevel: "Seuil de réapprovisionnement",
    safetyStock: "Stock de sécurité",
    expiryAlertDays: "Alerte de péremption (j)",
    expiryAlertDaysHint:
      "Délai d'alerte avant la date de péremption d'un lot. Les produits à rotation lente demandent un délai plus long.",
  ...
  sales: {
    ...
    creditSaleOption: "Vente à crédit (facture)",
    cashSaleHint: "Payée immédiatement. Un reçu de vente est délivré.",
    creditSaleHint: "Payable plus tard. Une facture est émise et reste ouverte.",
    willIssueReceipt: "Cette vente délivrera un reçu de vente.",
    willIssueInvoice: "Cette vente émettra une facture payable plus tard.",
    payment: "Règlement",
    paymentMethod: "Mode de règlement",
    paymentReference: "Référence du règlement",
    paymentReferencePlaceholder: "Code de transaction, n° de chèque…",
    amountTendered: "Montant remis",
    tenderHint: "Laisser vide si le montant exact est remis.",
    changeDue: "Monnaie à rendre",
    receipt: "Reçu de vente",
    receiptNumber: "Numéro de reçu",
    receipts: "Reçus de vente",
    issueInvoice: "Émettre une facture",
    issueInvoiceForReceipt: "Émettre une facture pour ce reçu",
    issueInvoiceReason: "Motif (facultatif)",
    issueInvoiceExplanation:
      "Une facture sera émise pour cette même vente. Le stock, la TVA et le chiffre d'affaires ne sont pas comptabilisés une seconde fois, et le reçu reste valable.",
    invoiceAlreadyIssued: "Facture déjà émise pour cette vente",
    ...
    unitPriceInclVat: "Prix unitaire TTC",
    discount: "Remise",
    tax: "TVA",
  ...
  invoicing: {
    ...
    creditNoteFor: "Note de crédit sur la facture",
    creditNoteReason: "Motif de la correction",
    creditNoteDetails: "Précisions",
    creditNoteLines: "Lignes à créditer",
    creditNoteQuantity: "Quantité créditée",
    creditNoteAmount: "Montant à créditer",
    creditNoteEmpty:
      "Indiquez au moins une ligne avec une quantité supérieure à zéro.",
    creditNoteIssued: "Note de crédit émise",
    creditNoteFailed: "Échec de l'émission de la note de crédit",
    creditNoteExceedsLine:
      "La quantité créditée ne peut pas dépasser la quantité facturée.",
    creditNotesIssued: "Notes de crédit émises",
    correctsInvoice: "Corrige la facture",
    restock: "Remettre en stock",
    restockHint:
      "À cocher uniquement si la chaîne du froid et les conditions de conservation ont été respectées. Sinon les unités sont mises en quarantaine puis détruites.",
    restockNotAvailable:
      "Cette facture n'est rattachée à aucune vente : la correction est purement financière et ne modifie pas le stock.",
    conditionNotes: "État des marchandises",
    returnableQuantity: "Retournable",
    creditReasons: {
      WRONG_QUANTITY: "Quantité facturée erronée",
      WRONG_PRICE: "Prix unitaire erroné",
      GOODS_RETURNED: "Marchandises retournées par le client",
      GOODS_DAMAGED: "Marchandises endommagées ou défectueuses",
      DISCOUNT_GRANTED: "Remise ou ristourne accordée",
      OTHER: "Autre",
    },

    // --- Déclaration à l'OBR ---
    // Les libellés de statut vivent ici plutôt que dans `status` : PENDING,
    // REJECTED et CANCELLED y existent déjà avec un tout autre sens.
    fiscalStatus: "Statut fiscal",
    fiscalSignature: "Signature fiscale",
    obrRegisteredNumber: "N° d'enregistrement OBR",
    obrElectronicSignature: "Signature électronique OBR",
    declaredAt: "Déclarée le",
    declareToObr: "Déclarer à l'OBR",
    declarationAttempts: "Tentatives de déclaration",
    fiscal: {
      NOT_REQUIRED: "Non déclarable",
      PENDING: "En attente de déclaration",
      DECLARED: "Déclarée à l'OBR",
      REJECTED: "Rejetée par l'OBR",
      CANCELLED: "Annulation déclarée",
    },
    fiscalPendingNote:
      "Cette facture sera transmise à l'OBR dans les prochaines minutes. Aucune action requise.",
    fiscalRejectedNote:
      "L'OBR a refusé cette facture et les tentatives automatiques sont épuisées. Corrigez la cause, puis relancez la déclaration.",
    fiscalDeclaredNote:
      "Cette facture a été acceptée par l'OBR. Le numéro d'enregistrement figure sur le PDF.",
  ...
  purchasing: {
    ...
    unitCost: "Prix unitaire fournisseur",
    unitCostCatalogHint: "Référence catalogue : %{cost}. Ajustez au prix négocié.",
    unitCostZeroWarning:
      "Prix unitaire à zéro : la ligne sera commandée sans valeur.",
  ...
  toasts: {
    ...
    invoiceDeclared: "Facture déclarée à l'OBR",
...
export const en: Dictionary = {
  ...
  catalog: {
    ...
    sellingPrice: "Selling price (VAT incl.)",
    wholesalePrice: "Wholesale price (VAT incl.)",
    priceInclVatHint:
      "Selling prices are entered VAT-inclusive, the amount the customer pays. The net-of-VAT base is derived automatically.",
    priceExclVat: "Net of VAT",
    unitCostExclVatHint: "Purchase cost, excluding VAT.",
    vatRate: "VAT rate",
    ...
    expiryAlertDaysHint:
      "How far ahead of a batch's expiry date to raise an alert. Slow-moving products need a longer lead time.",
  ...
  sales: {
    ...
    creditSaleOption: "Credit sale (invoice)",
    cashSaleHint: "Paid immediately. A sales receipt is issued.",
    creditSaleHint: "Payable later. An invoice is issued and stays open.",
    willIssueReceipt: "This sale will issue a sales receipt.",
    willIssueInvoice: "This sale will issue an invoice payable later.",
    payment: "Payment",
    paymentMethod: "Payment method",
    paymentReference: "Payment reference",
    paymentReferencePlaceholder: "Transaction code, cheque number…",
    amountTendered: "Amount tendered",
    tenderHint: "Leave blank if the exact amount is tendered.",
    changeDue: "Change due",
    receipt: "Sales receipt",
    receiptNumber: "Receipt number",
    receipts: "Sales receipts",
    issueInvoice: "Issue an invoice",
    issueInvoiceForReceipt: "Issue an invoice for this receipt",
    issueInvoiceReason: "Reason (optional)",
    issueInvoiceExplanation:
      "An invoice will be issued for this same sale. Stock, VAT and revenue are not posted a second time, and the receipt remains valid.",
    invoiceAlreadyIssued: "An invoice has already been issued for this sale",
    ...
    unitPriceInclVat: "Unit price (VAT incl.)",
    discount: "Discount",
    tax: "VAT",
  ...
  invoicing: {
    ...
    creditNoteFor: "Credit note against invoice",
    creditNoteReason: "Reason for correction",
    creditNoteDetails: "Details",
    creditNoteLines: "Lines to credit",
    creditNoteQuantity: "Quantity credited",
    creditNoteAmount: "Amount to credit",
    creditNoteEmpty: "Enter at least one line with a quantity greater than zero.",
    creditNoteIssued: "Credit note issued",
    creditNoteFailed: "Could not issue the credit note",
    creditNoteExceedsLine:
      "The credited quantity cannot exceed the quantity invoiced.",
    creditNotesIssued: "Credit notes issued",
    correctsInvoice: "Corrects invoice",
    restock: "Return to stock",
    restockHint:
      "Tick only if cold chain and storage conditions were maintained. Otherwise the units are quarantined and written off.",
    restockNotAvailable:
      "This invoice is not linked to a sale, so the correction is purely financial and will not move stock.",
    conditionNotes: "Condition of goods",
    returnableQuantity: "Returnable",
    creditReasons: {
      WRONG_QUANTITY: "Wrong quantity invoiced",
      WRONG_PRICE: "Wrong unit price charged",
      GOODS_RETURNED: "Goods returned by customer",
      GOODS_DAMAGED: "Goods damaged or defective",
      DISCOUNT_GRANTED: "Discount or rebate granted",
      OTHER: "Other",
    },

    // --- OBR declaration ---
    // Status labels live here rather than in `status`: PENDING, REJECTED and
    // CANCELLED already exist there meaning something entirely different.
    fiscalStatus: "Fiscal status",
    fiscalSignature: "Fiscal signature",
    obrRegisteredNumber: "OBR registration number",
    obrElectronicSignature: "OBR electronic signature",
    declaredAt: "Declared on",
    declareToObr: "Declare to OBR",
    declarationAttempts: "Declaration attempts",
    fiscal: {
      NOT_REQUIRED: "Not declarable",
      PENDING: "Awaiting declaration",
      DECLARED: "Declared to OBR",
      REJECTED: "Rejected by OBR",
      CANCELLED: "Cancellation declared",
    },
    fiscalPendingNote:
      "This invoice will be sent to the OBR within the next few minutes. No action needed.",
    fiscalRejectedNote:
      "The OBR refused this invoice and automatic retries are exhausted. Fix the cause, then declare it again.",
    fiscalDeclaredNote:
      "The OBR has accepted this invoice. The registration number appears on the PDF.",
    paymentReference: "Payment reference",
  ...
  purchasing: {
    ...
    unitCostCatalogHint: "Catalogue reference: %{cost}. Adjust to the quoted price.",
    unitCostZeroWarning:
      "Unit cost is zero: this line would be ordered at no value.",
  ...
  toasts: {
    ...
    invoiceDeclared: "Invoice declared to the OBR",
