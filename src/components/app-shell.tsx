  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: FileText,
        permissions: ["purchasing.view_supplier_invoice"],
      },
      {
        href: "/purchasing/supplier-payments",
        labelKey: "supplierPayments",
        icon: Wallet,
        permissions: ["purchasing.view_supplier_payment"],
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: TrendingUp,
        permissions: ["accounting.view_financial_overview"],
      },
      {
        href: "/accounting/expenses",
        labelKey: "expenses",
        icon: Receipt,
        permissions: ["accounting.view_expense"],
      },
      {
        href: "/accounting/categories",
        labelKey: "expenseCategories",
        icon: Tags,
        permissions: ["accounting.manage_expense_categories"],
      },
      {
